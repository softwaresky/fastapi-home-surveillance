...
var OpusDecoder = (function () {
    function OpusDecoder(sampling_rate, channels) {
        ...
        //TODO: Da vidam sto se desava tuka
        console.log(this.in_buf);
        console.log(this.out_len);
        console.log(Opus.getMaxFrameSize(channels));
    ...
    OpusDecoder.prototype.decode_float = function (packet) {
        ...
        let array = new Uint8Array(packet);

        this.in_buf.set(array);
